...
def upgrade():
    ...
    op.add_column('pipeline', sa.Column('cronjob_start_time', sa.String(length=300), nullable=True, comment='定时调度补录起点'))
    op.add_column('task', sa.Column('skip', sa.Boolean(), nullable=True, comment='是否跳过'))
