...
def upgrade():
    ...
    sa.Column('model_name', sa.String(length=100), nullable=False, comment='数据结构'),
    sa.Column('row_id', sa.String(length=500), nullable=False, comment='数据id'),
    ...
    op.add_column('etl_pipeline', sa.Column('workflow', sa.String(length=200), nullable=True, comment='调度引擎'))
    ...
    op.add_column('metadata_metric', sa.Column('remark', sa.Text(length=65536), nullable=True, comment='备注'))
